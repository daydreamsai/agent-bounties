...
**Agent Metadata**:
- Manifest: https://bridge-route-pinger-production-1647.up.railway.app/.well-known/agent.json
- x402 Metadata: https://bridge-route-pinger-production-1647.up.railway.app/.well-known/x402
...
2. Enter agent URL: https://bridge-route-pinger-production-1647.up.railway.app
...
curl https://bridge-route-pinger-production-1647.up.railway.app/.well-known/x402
```
