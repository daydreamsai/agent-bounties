...
`cross-dex-arbitrage-alert` scans V2-style DEX pools for a token pair, compares live reserve quotes, subtracts DEX fees and estimated swap gas, and returns profitable cross-DEX spreads.
