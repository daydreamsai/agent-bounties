  ...
  output: z.object({
    markets: z.array(
      z.object({
        venue: z.string(),
        market: z.string(),
        funding_rate: z.number().describe("Current hourly funding rate as a decimal (e.g. 0.0001 = 0.01%)"),
        funding_rate_annualized: z.number().describe("Annualized funding rate as a percentage (e.g. 87.6 = 87.6%)"),
        time_to_next: z.string(),
        time_to_next_seconds: z.number(),
        open_interest: z.number().describe("Open interest in asset units (e.g. number of BTC)"),
        open_interest_notional: z.string().describe("Open interest in USD (e.g. $1,234,567)"),
        skew: z.number(),
